...
module.exports = class extends BaseGenerator {
    get initializing() {
        return {
            ...
            displayLogo() {
                ...
                this.log(`\nWelcome to the ${chalk.bold.yellow('JHipster unity3d')} generator! ${chalk.yellow(`v${packagejs.version}\n`)}`);
            },
            checkJhipster() {
    ...
    writing() {
        ...
        try {
            this.registerModule(
                'generator-jhipster-unity3d',
                'entity',
                'post',
                'entity',
                'Generators microservice connectivity for unity3d'
            );
        } catch (err) {
    ...
    install() {
        ...
        this.log('End of unity3d generator');
    }
};
